...
uses UDmConexao, UDmTabelas, UCadProduto, UCadVenda, UMenuRelatorios;
...
begin
  if not Assigned(FrmMenuRelatorios) then
    FrmMenuRelatorios := TFrmMenuRelatorios.Create(Self);

  FrmMenuRelatorios.ShowModal;
  FreeAndNil(FrmMenuRelatorios);
end;
